...
<DModal btn={<MdOutlineDelete size={25} className='text-red-400 m-2 backdrop-blur-xl' />} header={'Are You Sure ?'} submit={<button className='w-full h-full rounded bg-red-500/70 dark:bg-red-400/90 hover:bg-red-600 dark:hover:bg-red-600  inline-block p-3' onClick={handleDelete}>Delete</button>}>
