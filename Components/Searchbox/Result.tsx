        ...
        <div className="flex gap-2 flex-wrap w-full">
          {results.map((blog: any) => (
            <Link
              href={`/blogs/${blog._id}`}
              key={blog._id}
              className="flex w-full items-center p-2 border border-slate-300 dark:border-slate-500 hover:border-orange-500 dark:hover:border-orange-400 hover:text-orange-500 dark:hover:text-orange-400 hover:bg-orange-200/50 dark:hover:bg-orange-800/10 rounded-md"
            >
              <Image
                width={200}
                height={200}
              ...
              <div className=" space-y-2">
                ...
                <p className="flex gap-2 items-center text-sm">
                  ...
                  />
                  <span className=" opacity-80">{blog.creator.username}</span>
                </p>
              </div>
            </Link>
          ))}
