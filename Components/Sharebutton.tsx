...
const ShareButton: React.FC<{
  ...
  return (
    <button
      ...
      className={` ${className} border text-orange-500 border-orange-500 rounded px-1 py-1 font-semibold hover:text-white hover:bg-orange-500 `}
    >
