        ...
        {open && (
          ...
          >
            {session?.user.dbid && (
              <li
                key={0}
                className="text-slate-800 dark:text-slate-300 border-b dark:border-slate-600 py-3 text-center overflow-hidden text-ellipsis whitespace-nowrap px-2 mx-auto"
              >
