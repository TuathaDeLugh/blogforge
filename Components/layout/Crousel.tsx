  ...
  if (!data || data.length === 0) {
    ...
    return (
      <div className=" w-full  max-w-[1500px] mx-auto lg:h-auto px-2 ">
        <div
          className={`relative w-full ${data[currentIndex].title ? 'h-[28rem]' : 'h-48 sm:h-[30rem] md:h-[35rem] lg:h-[40rem]'} m-auto overflow-hidden rounded-lg`}
        >
          ...
          <AnimatePresence>
            ...
            >
              <div
                className={`h-full ${data[currentIndex].title ? 'md:max-h-[28rem]' : 'max-h-48 sm:max-h-[30rem] md:max-h-[35rem] lg:max-h-[40rem]'}  w-full absolute lg:relative lg:py-2`}
              >
                <Image
                ...
                <div className="z-10 text-slate-200 lg:dark:text-slate-200  lg:text-slate-700 px-10 lg:p-4 mt-7 lg:mt-10 sm:space-y-8">
                  ...
                  <div className="my-3">
                    {data[currentIndex].category?.map((cat: any) => (
                      <span
                        key={cat}
                        className="my-3 text-sm bg-orange-400/50  md:bg-orange-200 md:dark:bg-orange-400/50 text-white md:text-slate-700 md:dark:text-white rounded-full px-2 py-1 mr-1"
                      >
                        {cat}
                      </span>
                    ))}
                    ...
                    <div className=" flex items-center">
                      ...
                      <div className="ml-3">
                        <p className="text-gray-700 dark:text-gray-400">
                          {data[currentIndex].creator?.username}
                        </p>
                  ...
                  <Link
                    ...
                    className="rounded p-1 text-sm absolute bottom-5 bg-orange-500 text-white"
                  >
                    View Article
                  </Link>
                </div>
