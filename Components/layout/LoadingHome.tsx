      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2 mb-2">
          {[...Array(3)].map((_, index) => (
            <div
              key={index}
              className="bg-gray-300 dark:bg-gray-700 px-3 py-1 rounded-full text-xs w-1/4 h-6"
            ></div>
          ))}
        </div>
  ...
  return (
    <div className="mx-auto px-4 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <section className="mb-12">
            <div className="flex justify-between items-end mb-6">
              <h2 className="text-3xl md:text-4xl px-2 border-l-8 border-gray-300 dark:border-gray-700 font-bold">
                Recent Blogs
              </h2>
            </div>
          ...
          <section className="mb-12">
            <h2 className="text-3xl md:text-4xl px-2 border-l-8 border-gray-300 dark:border-gray-700 font-bold mb-4">
            ...
            <div className="flex flex-wrap gap-2 items-center justify-center">
              {[...Array(11)].map((_, index) => (
                <div
                  key={index}
                  className="bg-gray-300 dark:bg-gray-700 px-3 py-1 rounded-full text-xs h-6 w-24"
                ></div>
              ))}
            </div>
          </section>
        ...
        <div>
          <section className="mb-12">
            <h2 className="text-3xl md:text-4xl px-2 border-l-8 border-gray-300 dark:border-gray-700 font-bold mb-6">
              Popular Blogs
            </h2>
            <div className="space-y-6">
              {[...Array(4)].map((_, index) => (
          ...
          <section className="mb-12 bg-gray-100 dark:bg-gray-800 p-6 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[...Array(4)].map((_, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center bg-white dark:bg-gray-600/50 p-4 rounded-lg shadow animate-pulse "
                >
                  ...
                  <div className="grid grid-cols-3 gap-2 w-full">
                    {[...Array(3)].map((_, idx) => (
                      <div
                        key={idx}
                        className="h-4 bg-gray-300 dark:bg-gray-700 w-1/3 rounded-full"
                      ></div>
                    ))}
                  </div>
                </div>
