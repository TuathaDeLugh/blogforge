...
export default function Navbar() {
  ...
  const closeNavbarWithDelay = useCallback(() => {
    setTimeout(() => {
    ...
    <>
      <nav className="sticky top-0 left-0 right-0 z-50 ">
        <div className="flex max-w-[1500px] mx-auto ">
          <div
            ref={navRef}
            className="grow  px-2 md:px-4 shadow-sm m-2 text-gray-700 bg-white/80 dark:text-slate-200 dark:bg-slate-800/80 dark:border-slate-600 dark:shadow-slate-500/50 backdrop-blur-sm border rounded-xl flex md:items-center lg:max-w-screen-2xl items-start"
          >
            ...
            <div className=" grow  justify-between   md:items-center md:flex ">
              ...
              >
                ...
                {navbar ? (
                  <ul
                    className={` pb-5 md:pb-0 items-center justify-center md:flex `}
                  >
                    {navData.map((link) => {
                      return (
                        <>
