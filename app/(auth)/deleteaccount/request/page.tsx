...
export default function DelAccountReq() {
      ...
      >
        ...
        >
          ...
          <Div className="md:w-[450px] text-center space-y-6"
            ...
            transition={{ duration: 0.5, delay: 0.3 }}>
            <p>
              Looks like you need to delete your account! Just need to confirm your email address by clicking the button.
            </p>
            <div className="md:w-[450px] text-center flex items-center justify-center">
              <button
                disabled={disabled || timer !== null}
                onClick={handleVerifyEmail}
                className="text-white w-1/3 bg-red-400 hover:bg-red-600 disabled:opacity-50 disabled:pointer-events-none font-semibold rounded-md text-sm px-4 py-3 flex items-center justify-center gap-4"
              >
                Get Email
                {disabled && (
