...
export default function ResetReq() {
  ...
  return (
    <div className="flex min-h-[92vh] md:min-h-[90vh] items-center mx-auto max-w-[1500px] justify-center mb-4 px-4 lg:px-8">
      <Div
      ...
      >
        <div className="mx-auto p-5 md:p-7 rounded-lg border shadow bg-white dark:bg-gray-900 dark:border-slate-500 dark:shadow-slate-600 min-h-[400px]">
          ...
          <Div
            className="md:w-[450px] text-center mt-6"
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5, delay: 0.3 }}
          >
...
function Form({ useremail }: { useremail?: string | null }) {
  ...
  return (
    <form
      ...
      autoComplete="off"
      className=" space-y-6 pt-10 pb-4 "
    >
      <p>Enter your email we will send reset link by email</p>
