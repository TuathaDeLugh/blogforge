...
export default function Terms() {
  return (
    <div className=" mx-auto max-w-[1500px] flex md:min-h-[90vh] items-center">
      <Div
      ...
      >
        ...
        <div className="data">
          <p>
            <u>Last updated: 2024-05-25</u>
          </p>
          <h2>
            1. <b>Introduction</b>
          </h2>
          <p>
            Welcome to <b>Blog Forge</b> (“Company”, “we”, “our”, “us”)!
          </p>
          <p>
            These Terms of Service (“Terms”, “Terms of Service”) govern your use
            of our website located at <b>https://blogforge.vercel.app</b>{' '}
            (together or individually “Service”) operated by <b>Umang Sailor</b>
            .
          </p>
          <p>
          ...
          <p>
            ...
            <b>service@blogforge.in</b> so we can try to find a solution. These
          ...
          <p>
            ...
            emailing at service@blogforge.in.
          </p>
          ...
          <blockquote>
            <p>
              (i) Content is yours (you own it) and/or you have the right to use
              it and the right to grant us the rights and license as provided in
              these Terms, and{' '}
            </p>
            <p>
              (ii) that the posting of your Content on or through Service does
          ...
          <p>
            Umang Sailor has the right but not the obligation to monitor and
            edit all Content provided by users.
          </p>
          <p>
            In addition, Content found on or through this Service are the
            property of Umang Sailor or used with permission. You may not
          ...
          <p>
            ...
            property of Umang Sailor and its licensors. Service is protected by
            ...
            without the prior written consent of Umang Sailor.
          </p>
          ...
          <p>
            ...
            email to service@blogforge.in, with the subject line: “Copyright
          ...
          <p>
            You may provide us either directly at service@blogforge.in or via
          ...
          <p>
            ...
            that are not owned or controlled by Umang Sailor.
          </p>
          <p>
            Umang Sailor has no control over, and assumes no responsibility for
          ...
          <p>
            ...
            laws of India(Gujarat), which governing law applies to agreement
          ...
          <p>
            ...
            by email: <b>service@blogforge.in</b>.
          </p>
        </div>
      </Div>
    </div>
