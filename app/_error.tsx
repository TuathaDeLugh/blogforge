              ...
              <div>
                ...
                <div className="">
                  ...
                  <p className="my-2 text-gray-800 dark:text-gray-400">
                    Sorry about that! Please visit our homepage or refresh.
                  </p>
                  <div className="grid grid-flow-col grid-cols-2 w-[80%] gap-5">
                    <a
                      href={path}
                      className=" block my-2 border rounded md py-4 text-center bg-orange-400 text-white hover:bg-orange-700 
