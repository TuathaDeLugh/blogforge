...
interface AdminActionTemplateFormProps {
  template?: AdminActionTemplate | null;
  onClose: () => void;
}
...
export default function AdminActionTemplateForm({ template, onClose }: AdminActionTemplateFormProps) {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      actionType: template?.actionType || 'account_ban',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              >
                ...
                <option value="comment_ban">Comment Ban</option>
                <option value="username_change">Username Change</option>
