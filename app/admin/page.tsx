    ...
    <section className='md:my-6'>
      <div className="md:relative -z-10">
        ...
        <H1
          ...
          transition={{ duration: 0.5 }} className="pl-2 text-2xl md:text-4xl font-bold border-l-8 border-orange-400 dark:text-white">
          Admin Panal
        </H1>
      </div>
      {stats && (
        <>
          ...
          <Div
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }} className="flex justify-around gap-4 w-full border-b pb-2 md:pb-5 dark:border-slate-400 mt-5">
