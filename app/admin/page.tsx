        ...
        <>
          ...
          >
            <div className="relative bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-blue-100 text-xs mt-1">Published content</p>
                </div>
            ...
            <div className="relative bg-gradient-to-br from-purple-500 to-purple-600 text-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-100 text-sm font-medium">Total Emails</p>
                  <p className="text-3xl font-bold">{stats.totalEmails}</p>
                  <p className="text-purple-100 text-xs mt-1">Contact messages</p>
                </div>
            ...
            <div className="relative bg-gradient-to-br from-orange-500 to-orange-600 text-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">{stats.popularCategories?.length || 0}</p>
                  <p className="text-orange-100 text-xs mt-1">Active categories</p>
                </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow border-l-4 border-red-500">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold">{stats.mostSavedBlogs?.reduce((acc: number, blog: any) => acc + (blog.usersave || 0), 0) || 0}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow border-l-4 border-blue-500">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold">{stats.mostSharedBlogs?.reduce((acc: number, blog: any) => acc + (blog.share || 0), 0) || 0}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow border-l-4 border-green-500">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold">{stats.mostCommentedBlogs?.reduce((acc: number, blog: any) => acc + (blog.commentsCount || 0), 0) || 0}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow border-l-4 border-yellow-500">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold">{stats.recentBlogs?.length || 0}</p>
                </div>
              </div>
            </div>
          </Div>
          ...
          <Div
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }} className="bg-white dark:bg-slate-700/60 shadow-lg p-4 rounded-lg mt-8">
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody>
                  {stats.topWriters.map((writer: any) => (
                    <tr key={writer._id} className='odd:bg-transparent even:bg-slate-100 dark:even:bg-slate-800/50'>
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody>
                    {stats.mostCommentedBlogs.map((blog: any) => (
                      <tr key={blog._id} className='odd:bg-transparent even:bg-slate-100 dark:even:bg-slate-800/50'>
                        <td className="py-2 px-4 border-b dark:border-slate-600">
