    ...
    <>
      <section className="px-4 lg:px-8 mx-auto max-w-[1500px] animate-pulse duration-300">
        <div className="relative my-5 md:mt-16 animate-pulse duration-300">
          ...
          <h1
            className="pl-2 text-3xl font-bold border-l-8 border-slate-400 md:text-5xl dark:text-white">
        ...
        <div className='flex justify-center flex-wrap lg:border-b dark:border-slate-400 pb-10'>
          ...
          <div className=' text-lg w-full '>
            <div className='mt-5 flex flex-wrap'>
...

              {
                review.category?.map((category) => {
                  return (
                    <span key={category.split('_').join(' ')} className='bg-slate-300 dark:bg-slate-600 rounded-full mt-2 w-20 p-3 mx-2' />
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 ">
              ...
              <p className='rounded-full  tracking-wider mt-3 bg-slate-300 dark:bg-slate-600 py-3 px-20'>
              ...
              <div
                ...
                <div
                  className="bg-slate-300 dark:bg-slate-600 mt-3 text-white rounded-full  w-full py-5 md:w-40 hover:bg-orange-600 focus:outline-none focus:shadow-outline-green active:bg-orange-800 disabled:opacity-30 flex justify-center items-center gap-2"
                />
