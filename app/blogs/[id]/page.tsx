            ...
            <div className="w-full p-2 lg:P-0 px-2">
                ...
                >
                  <span className=" text-orange-500 dark:text-orange-400 flex items-center  font-medium">
                    ...
                    <DModal
                      btn={
                        <IoIosInformationCircleOutline
                          size={20}
                          className="text-orange-500 dark:text-orange-400 shadow-md rounded-full m-2 backdrop-blur-xl"
                        />
                      }
                      header="How it count ?"
                      timerDuration={10}
                    >
                      ...
                      <div>
                        <p>User receive : +1</p>
                        <p>User Open Link : +1</p>
                        <p>User receive & open : +2</p>
                      </div>
                    </DModal>
                    :{' '}
                  </span>{' '}
                  {blog.share}
                  <ShareButton
                    link={`${process.env.API_URL}share?blog=${encodeURIComponent(blog.title)}`}
                    blogId={blog._id}
                  />
                </P>
                <Div
              ...
              <div className="mt-3">
                ...
                >
                  ...
                  <Link
                    href={`/writer/${blog.creator.username}`}
