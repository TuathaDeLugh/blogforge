...
export default function contact() {
  return (
    <div class="grid sm:grid-cols-2 items-center gap-16 my-6 mx-auto max-w-7xl  font-[sans-serif]">
            ...
            <form class="mx-auto space-y-4 p-7 rounded-lg ">
                <input type='text' placeholder='Name'
                    class="w-full rounded-md py-3 px-4 bg-gray-100 dark:bg-gray-700 text-sm outline-blue-500" />
                <input type='email' placeholder='Email'
                    class="w-full rounded-md py-3 px-4 bg-gray-100  dark:bg-gray-700 text-sm outline-blue-500" />
                <input type='text' placeholder='Subject'
                    class="w-full rounded-md py-3 px-4 bg-gray-100 dark:bg-gray-700 text-sm outline-blue-500" />
                <textarea placeholder='Message' rows="6"
                    class="w-full rounded-md px-4 bg-gray-100 dark:bg-gray-700 text-sm pt-3 outline-blue-500"></textarea>
                <button type='button'
