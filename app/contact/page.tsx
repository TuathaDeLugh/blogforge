...
export default function Contact() {
  ...
  return (
    <div className=" mx-auto max-w-[1500px] flex md:min-h-[90vh] items-center">
      <div className="px-4 md:px-10 grid md:grid-cols-2 items-center gap-16 my-6 mx-auto ">
        <Div
          className=""
        ...
        >
            ...
            <ul className="mt-3">
              <li className="flex items-center">
                ...
                <p className=" text-sm ml-3">
                  ...
                  <strong>service@blogforge.in</strong>
                </p>
              </li>
            </ul>
          </Div>
          <Div
            ...
            className="mt-12"
          >
            <h2 className="text-lg font-semibold text-orange-400">FAQs</h2>
            <ul className="mt-3">
              <li className="flex items-center">
                <Link
                  href={'/faq'}
                  className="bg-[#e6e6e6cf] dark:bg-slate-700 p-4 rounded-full flex items-center justify-center shrink-0"
                >
                ...
                <p className=" text-sm ml-3">
                  ...
                  <Link
                    href="/faq"
                    className="text-orange-500 transition hover:underline dark:text-orange-400"
                  >
                    FAQs
                  </Link>
                </p>
