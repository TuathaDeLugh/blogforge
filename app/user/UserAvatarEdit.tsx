              ...
              <div className="mb-10 text-base leading-relaxed  ">
                <div className="flex flex-wrap gap-4 max-h-72 overflow-auto justify-center">
                  <AiOutlineUser
                    ...
                    width={100}
                    height={100}
                    className={`w-20 h-20 p-2 rounded-full text-gray-400 cursor-pointer border-2  transition duration-300 ${selectedAvatar === "" ? 'border-2 border-orange-500 ' : 'dark:border-gray-500'
                      }`}
                  ...
                  {session && session.user && session.user.image ? (
                    <Image
                      ...
                      width={100}
                      height={100}
                      className={`w-20 h-20 rounded-full cursor-pointer border-2 p-[1px]  transition duration-300 ${selectedAvatar === session.user.image ? 'border-2 border-orange-500' : 'border'
                        }`}
                  ...
                  {avatars.map((avatar, index) => (
                    <Image
                      ...
                      width={100}
                      height={100}
                      className={`w-20 h-20 rounded-full cursor-pointer border-2 p-[1px]  transition duration-300 ${selectedAvatar === avatar ? 'border-2 border-orange-500' : 'border-transparent'
                        }`}
