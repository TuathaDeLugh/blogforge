...
const NewBlogForm: React.FC = () => {
    ...
    const {
        ...
        onSubmit: async (values, action) => {
            ...
            const postapi = async () => {
                ...
                // Upload Data in database Storage with firebase file link
                const data = {
                    title: values.title,
    ...
    return (
        <Div className="h-full flex items-center relative mb-5"
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}>
            <div className="mx-auto mt-8 w-full">
                <form onSubmit={handleSubmit} className="mx-auto p-4 md:p-7 rounded-lg border shadow bg-white dark:bg-gray-900 dark:border-slate-500 dark:shadow-slate-600">
                    ...
                    <div className='inline-block w-full'>
                        ...
                        <div className={`border ${errors.category && touched.category ? '  border-red-400 dark:border-red-600 placeholder-red-600/50' : ' border-transparent '} rounded bg-gray-100 dark:bg-gray-700 px-[14px] py-3`}>
                            <label htmlFor="category" className={`${errors.category && touched.category ? "text-red-400 dark:text-red-600 " : " text-gray-400  "} block font-medium mr-2`}>Category:</label>
                    ...
                    <div
                        ...
                        <div
                            className={`relative p-4 border-dashed  border-2 ${isDragging ? 'border-orange-400 bg-orange-400/10' : errors.images && touched.images ? 'border-red-600 dark:border-red-500 bg-gray-100 dark:bg-gray-700 ' : 'border-gray-300 dark:border-gray-500 bg-gray-100 dark:bg-gray-700'
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center space-y-4">
                                <label
                                    htmlFor="images"
                                    className={`text-sm ${isDragging ? 'text-orange-400' : errors.images && touched.images ? 'text-red-600 dark:text-red-500' : 'text-gray-600 dark:text-gray-200'
                                        } cursor-pointer`}
                                >
                                    {isDragging ? 'Drop your images here' : 'Click / Drag & Drop to add images'}
                                </label>
                                {imageUrls.length > 0 && (
                    ...
                    <div className="w-full inline-block">
                        ...
                        >
                            <label htmlFor="detail" className={`${errors.detail && touched.detail ? "text-red-400 dark:text-red-600 " : " text-gray-400  "} block font-medium text-base mr-2`}>Detail:</label>
                            <RichTextEditor
                                value={values.detail}
