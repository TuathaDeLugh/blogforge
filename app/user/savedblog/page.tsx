        ...
        >
          ...
          <div className="w-10">
            <DModal
              btn={
                <IoIosInformationCircleOutline
                  size={20}
                  className=" shadow-md rounded-full m-2 backdrop-blur-xl"
                />
              }
            ...
            >
              ...
              />
              <p>
                This tab display your saved blogs those are publically
                avaliable. Deleted or Private blogs are not shown here
              </p>
            </DModal>
          </div>
        </H1>
